...
public class AnalyzerMenu extends AbstractContainerMenu {
    ...
    public AnalyzerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 33, 5));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 33, 41));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 93, 5));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 93, 23));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 93, 41));
            this.addSlot(new SlotItemHandler(iItemHandler, 5, 111, 5));
            this.addSlot(new SlotItemHandler(iItemHandler, 6, 111, 23));
            this.addSlot(new SlotItemHandler(iItemHandler, 7, 111, 41));
            this.addSlot(new SlotItemHandler(iItemHandler, 8, 129, 5));
            this.addSlot(new SlotItemHandler(iItemHandler, 9, 129, 23));
            this.addSlot(new SlotItemHandler(iItemHandler, 10, 129, 41));
        });
