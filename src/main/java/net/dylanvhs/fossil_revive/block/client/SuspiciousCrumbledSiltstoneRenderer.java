package net.dylanvhs.fossil_revive.block.client;
...
@OnlyIn(Dist.CLIENT)
public class SuspiciousCrumbledSiltstoneRenderer implements BlockEntityRenderer<SuspiciousCrumbledSiltstoneEntity> {
    private final ItemRenderer itemRenderer;

    public SuspiciousCrumbledSiltstoneRenderer(BlockEntityRendererProvider.Context pContext) {
        this.itemRenderer = pContext.getItemRenderer();
    }

    public void render(SuspiciousCrumbledSiltstoneEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
