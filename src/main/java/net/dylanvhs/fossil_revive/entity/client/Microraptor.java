...
public class Microraptor<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(((MicroraptorEntity) entity).flapAnimationState, ModAnimationDefinitions.MICRORAPTOR_FLAP, ageInTicks, 1f);
		this.animate(((MicroraptorEntity) entity).sitAnimationState, ModAnimationDefinitions.MICRORAPTOR_SIT, ageInTicks, 1f);
