...
public class AnalyzerRecipe implements Recipe<SimpleContainer> {
    ...
    public AnalyzerRecipe(NonNullList<Ingredient> inputItems, ItemStack output, ResourceLocation id) {
    ...
    public static class Serializer implements RecipeSerializer<AnalyzerRecipe> {
        ...
        public static final ResourceLocation ID = new ResourceLocation(FossilRevive.MOD_ID, "analyzing");
        ...
        public AnalyzerRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new AnalyzerRecipe(inputs, output, pRecipeId);
        }
